...
INCLUDE	"music\iloveretroworks_a.mus.asm"
...
SONG_0: INCBIN "iloveretroworks.mus.bin"	; Loading screen... only for the disk version
retroworks_logo: INCBIN "rwks_logo.bin"
